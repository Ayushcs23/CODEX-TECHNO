...
|---------|-----------|-------------|
| **Task 1** | [https://github.com/Ayushcs23/CODEX-TECHNO/tree/main/Level_1_task_1](./Level1_Task1_LandingPage) | Developed a static landing page using HTML and CSS with multiple sections like header, footer, and responsive layout. Emphasis was given to layout, spacing, and design consistency. |
| **Task 2** | [https://github.com/Ayushcs23/CODEX-TECHNO/tree/main/level_1_task_2](./Level1_Task2_Portfolio) | Created a personal portfolio website that includes an introduction, resume section, projects showcase, and contact information. |
...
Feel free to explore the repository and connect with me on [LinkedIn](www.linkedin.com/in/ayush-shukla-487660216) for more updates and projects.
...
- The work demonstrates beginner-level to intermediate front-end web development skills.
